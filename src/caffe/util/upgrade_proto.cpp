...
bool UpgradeV1LayerParameter(const V1LayerParameter& v1_layer_param,
  ...
  for (int i = 0; i < v1_layer_param.blob_share_mode_size(); ++i) {
    ...
    case V1LayerParameter_DimCheckMode_STRICT_DIM:
      mode = ParamSpec_DimCheckMode_STRICT_DIM;
      break;
    case V1LayerParameter_DimCheckMode_PERMISSIVE_DIM:
      mode = ParamSpec_DimCheckMode_PERMISSIVE_DIM;
      break;
    default:
